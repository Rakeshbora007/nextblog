      ...
      <div className="flex flex-col sm:flex-row gap-5 w-full">
        <Link href={`blog/${filteredFeaturedPosts[0]?._id}`} className="relative w-full sm:w-[50%] md:w-[60%] lg:w-[70%] xl:w-[85%] h-[260px] sm:h-[418px] md:h-[520px] lg:h-[620px] xl:h-[730px]">
          <Image alt="s" className="object-cover rounded-lg" src={filteredFeaturedPosts[0]?.image} fill priority
            sizes="(min-width: 1920px) 1070px, (min-width: 1300px) calc(52.33vw + 76px), (min-width: 1040px) calc(58.33vw - 59px), (min-width: 920px) calc(55vw - 59px), (min-width: 780px) calc(30.83vw + 159px), (min-width: 640px) calc(50vw - 24px), calc(50vw - 74px)" />
          ...
          {[1, 2].map((e) => (
            <React.Fragment key={e._id}>
              <Link href={`blog/${filteredFeaturedPosts[e]?._id}`} className="relative w-full h-[100px] sm:h-[200px] md:h-[250px] lg:h-[300px] xl:h-[354px] max-sm:h-[110px]">
                <Image alt="s" className="rounded-lg object-cover" src={filteredFeaturedPosts[e]?.image} fill priority sizes="(min-width: 1920px) 630px, (min-width: 1300px) calc(30.83vw + 44px), (min-width: 1040px) calc(41.67vw - 42px), (min-width: 920px) calc(45vw - 41px), (min-width: 780px) calc(25.83vw + 131px), calc(50vw - 44px)" />
